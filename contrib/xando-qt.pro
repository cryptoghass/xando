...
RESOURCES += src/qt/xando.qrc src/qt/xando_locale.qrc

TRANSLATIONS += src/qt/locale/xando_bg.ts \
                src/qt/locale/xando_de.ts \
                src/qt/locale/xando_en.ts \
                src/qt/locale/xando_es.ts \
                src/qt/locale/xando_fi.ts \
                src/qt/locale/xando_fr.ts \
                src/qt/locale/xando_it.ts \
                src/qt/locale/xando_ja.ts \
                src/qt/locale/xando_pl.ts \
                src/qt/locale/xando_pt.ts \
                src/qt/locale/xando_ru.ts \
                src/qt/locale/xando_sk.ts \
                src/qt/locale/xando_sv.ts \
                src/qt/locale/xando_vi.ts \
                src/qt/locale/xando_zh_CN.ts \
                src/qt/locale/xando_zh_TW.ts
