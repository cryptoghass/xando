...
#if defined(NDEBUG)
#error "Xando cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Xando Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 1) return 150000 * COIN;
	...
	if( nHeight > 1 && nHeight <= 5000 ) {
	        ...
	        nSubsidy = 150 * COIN;
	} else if( nHeight > 20000 && nHeight <= 350000 ) {
	        nSubsidy = 100 * COIN;
	        ...
	        nSubsidy = 3 * COIN;
	} else if( nHeight > 900000 && nHeight <= 950000 ) {
	        nSubsidy = 2 * COIN;
	} else if( nHeight > 950000 && nHeight <= 1000000 ) {
	        nSubsidy = 1 * COIN;
	} else {
		nSubsidy = 0.5 * COIN;
	}
