/* src/config/xando-config.h.  Generated from xando-config.h.in by configure.  */
/* src/config/xando-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://xando.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Xando Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Xando Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xando"
