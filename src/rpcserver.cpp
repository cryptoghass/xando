...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* XDO features */
        {"xando", "masternode", &masternode, true, true, false},
        {"xando", "masternodelist", &masternodelist, true, true, false},
        {"xando", "mnbudget", &mnbudget, true, true, false},
        {"xando", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"xando", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"xando", "mnsync", &mnsync, true, true, false},
        {"xando", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"xando", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use xandod, or the -server option to xando-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Xando Alert\" admin@foo.com\n"),
...
{
    return "> xando-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:17599/\n";
}
