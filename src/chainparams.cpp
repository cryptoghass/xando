...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000007b03bee6c5b9a06072d3ac9b512122218b9874407f3bec4c2012bb387f5"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1529731729, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 6000; //Params().MasternodeColleteralLimxDev()
        nModifierUpdateBlock = 1; // we use the version 2 for dmd
        nMaxMoneyOut = 380000000 * COIN;

        const char* pszTimestamp = "Xando Experiment Goes Live";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1529731729;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 21122907;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000007b03bee6c5b9a06072d3ac9b512122218b9874407f3bec4c2012bb387f5"));
        ...
        nStartMasternodePayments = 1529731729; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1529731730;
        genesis.nNonce = 21985207;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000facae73d483d9a14c81bb0f0abf47c8dc6300cbf8537603dc691cfc755a"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Xando BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Xando BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Xando BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1529731730;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1529731731;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 2;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x70b4500ed3ec3458ccb7393cdd221fdc0287c54dd35288fdbf237672ec05d646"));
