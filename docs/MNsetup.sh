...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='xando.conf'
CONFIGFOLDER='/root/.xando'
COIN_DAEMON='xandod'
COIN_CLI='xando-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/xando-club/xando.git'
COIN_TGZ='https://github.com/xando-club/xando/releases/download/untagged-a6e13ff1434b3c98da9d/linux-binaries.tgz'
